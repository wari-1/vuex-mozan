  ...
  <div class="shouyingtai">
    ...
    <div class="main6">
      <div class="inner">
        <div class="top">
          ...
          <ul class="nav">
            <li :class="$route.fullPath==='/cart1'?'active':''">购物车</li>
            <li :class="$route.fullPath==='/order'?'active':''">填写订单</li>
            <li :class="$route.fullPath==='/shouyingtai1'?'active':''">付款，完成订单</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="main9">
      <div class="inner">
        <div class="boxx">
          <div class="box">
            ...
            <div class="box1">
              ...
              <img src="../assets/images/money1_15.jpg" alt />
            </div>
            <div class="box1 active">
              <span v-if="true">√</span>
              <img src="../assets/images/money1_12.jpg" alt />
            </div>
            <div class="box1">
              <span v-if="false">√</span>
              <img src="../assets/images/money1_18.jpg" alt />
            </div>
            <div class="box1">
              <span v-if="false">√</span>
              <img src="../assets/images/money1_21.jpg" alt />
            </div>
          </div>
        </div>
        <div class="foot">
        ...
        <el-dialog :visible.sync="dialogFormVisible" title="收银台">
          <div class="content">
            <span>请您在新打开的网上银行页面进行支付</span>
            <span>支付完成前请不要关闭该窗口</span>
            <div class="btn">
              <button @click="backHome">已完成支付</button>
